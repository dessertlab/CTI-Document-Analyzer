 ...
 */
    ...
    //DWEP-2514 nav redesign

    if ($jq1('#onetrust-banner-sdk').length) {
        var bannerht = $jq1('#onetrust-banner-sdk').outerHeight() - 35 + 'px';
    ...
    //     calcNavbarwidth();
    // } else if($jq1(window).width() > 800 && $jq1(window).width() < 1025){
    // 	tabletNavigationTrigger();
    // }
    // else {
    ...
    // 	} else if($jq1(window).width() > 800 && $jq1(window).width() < 1025){
    // 		tabletNavigationTrigger();
    //         if($jq1('.NavShow').length){
    //             $jq1(".tn-links > .navbar-toggle").trigger('click');
    //             $jq1('#topNav').removeClass('in');
    //         }
    //         $jq1('.tn-panel').removeAttr("style");
    // 	}
    // 	else {
...
// 	reselEventTriggers();
//     /*$jq1('.tl-hide').each(function () {
//         var link = $jq1(this).find('.tr-nav-title').html();
//         var dataselector = $jq1('.tl-hide').find('.tr-nav-sub').attr('class').split(' ')[0]
//         var html = '<div class="tl-nav tl-nav-mob"><div class="tl-nav-links"><p class="tn-main-link">' + link + '</p><ul><li><a href="javascript:void(0);" data-show-left='+dataselector+'> &nbsp</a></li></ul></div></div>';
//         $jq1(this).append(html);
//     })*/
//     $jq1('.tl-nav-links').each(function () {
//         var link = '<p class="tr-mob-link">' + $jq1(this).find('.tn-main-link').html() + '</p>';
//         $jq1(this).find('ul').before(link);
//     })
// 	$jq1(document).on({
// 			click: function () {
// 				var currLink = $jq1(this).data("show");
...
// 				var selector = '.' + currLink + '';
// 				$jq1('.tn-subgroup').removeClass('active');
// 				$jq1(selector).addClass("active").find('.tl-nav-links').show();
//                 $jq1(selector).addClass("active").find('.tl-nav-links').show();
//                 if ($jq1(selector).hasClass('tl-hide')) {
//                     var ht = $jq1(selector).find('.tr-left').outerHeight() + $jq1(selector).find('.tr-nav-promo').outerHeight();
//                     $jq1('.tn-panel').height(ht + 40);
//                 }

// 				$jq1(this).data('timeout', setTimeout(function () {
// 					showNavPanelMobile(selector, curr);
// 				}, 300));
// 			}
// 		},
// 		".tn-links li a");
...
// 				$jq1(this).data('timeout', setTimeout(function () {
// 					$jq1('.tn-panel').removeClass("show-panel");
// 					$jq1('#topNav').removeClass("moveLeft");
// 					$jq1('.tl-nav-links').removeClass("active");
// 				}, 300));
// 			}
// 		},
// 		".tn-main-link");
...
// 			$jq1(selector).show();
// 			$jq1(this).data('timeout', setTimeout(function () {
// 				showNavSubPanelMobile(selector, curr);
//                 var ht = $jq1(selector).find('.tr-left').outerHeight() + $jq1(selector).find('.tr-nav-promo').outerHeight();
//                 $jq1('.tn-panel').height(ht+40);
// 			}, 500));
// 		}
...
//                 var that = $jq1(this);
// 				$jq1(this).data('timeout', setTimeout(function () {
//                     if(that.closest('.tl-hide').length){
//                         $jq1('.tn-panel').removeClass("show-panel");
//                         $jq1('#topNav').removeClass("moveLeft");
//                         $jq1('.tl-nav-links').removeClass("active");
//                     }
// 					$jq1('.tl-nav').removeClass("moveLeft");
// 					$jq1('.tr-nav').removeClass("active");
//                     $jq1('.tn-panel').height('auto');
// 				}, 300));
// 			}
// 		},
// 		".tr-nav-title");
...
// function showNavPanelMobile(selector, curr) {
// 	$jq1('.tn-panel').addClass("show-panel");
// 	$jq1('#topNav').addClass("moveLeft");

// 	if (!$jq1(selector).hasClass("active")) {
// 		$jq1('.tl-nav-links').not($jq1(selector)).hide();
// 		$jq1(".tn-links li a").removeClass("active");
// 		curr.addClass('active');
// 	}
// 	clearTimeout(curr.data('timeout'));
// }

// function showNavSubPanelMobile(selector, curr) {
// 	$jq1(".tl-nav-links li").removeClass("active");
//     $jq1(".tr-nav-sub").removeClass("active");
// 	$jq1('.tl-nav').addClass('moveLeft');
// 	$jq1(selector).closest('.tr-nav').addClass('active');
// 	clearTimeout(curr.data('timeout'));
// }

// $jq1(document).on({
// 	click: function () {
// 		$jq1('.top-navigation').toggleClass('show');
// 		$jq1('.header-group').toggleClass('NavShow');
// 		$jq1('#topNav').removeClass("moveLeft");
// 		$jq1('.tn-panel').removeClass("show-panel");
// 		$jq1('.tn-subgroup').removeClass('active');
// 		$jq1('.tl-nav').removeClass("moveLeft");
// 		$jq1('.tr-nav').removeClass('active');
//         $jq1('.tn-panel').height('auto');
// 		$jq1(this).toggleClass('close-nav');
// 	}

// }, ".tn-links > .navbar-toggle");


// function tabletNavigationTrigger(){
// 	reselEventTriggers();
// 	$jq1(document).on({
// 			click: function () {
// 				var currLink = $jq1(this).data("show");
...
/*  $jq1(document).on('click','.tn-links .navbar-toggle', function() {
    $jq1('#topNav').toggleClass('in').slideToggle(500);
  });

 $jq1(document).on('click','.hdr-mobile-group-toggle', function() {
    $jq1('.hdr-mobile-group').toggleClass('in').slideToggle(500);
  });*/
...
if ($jq1("form#globalsearch").length > 0) {
    ...
    glbSearchCont.querySelector("#ub-search").onkeydown = function (e) {
        ...
        if (e.which == 13) {
			...
			search_text = $jq1("#ub-search").val().trim() == "" ?  $jq1(".menu-item #ub-search").val().trim() : encodeURIComponent($jq1("#ub-search").val());
            if($('.dalmore-header').length == 1){
                var search_text = $jq1(".hdr-search #ub-search").last().val().trim() == "" ? $jq1(".hdr-search #ub-search").last().val().trim() : encodeURIComponent($jq1(".hdr-search #ub-search").last().val());
			    search_text = $jq1(".hdr-search #ub-search").last().val().trim() == "" ?  $jq1(".menu-item #ub-search").val().trim() : encodeURIComponent($jq1(".hdr-search #ub-search").last().val());
            }
    ...
    */
    ...
    function create_lang_mapping() {
        ...
        var languagemapping = {
            ...
            "nordics":{"language": "English-NORDICS"},
...
/******************New Header JS**********************/
$jq1(document).ready(function () {
    if($jq1('.dalmore-header').length == 1){   //DWEP-2514 enable login arrow for dalmore header
        $jq1('.right-arrow.login-arrow').removeClass('d-none');
    }
    if ($jq1("meta[name='viewport']").length && $jq1("meta[name='viewport']").attr("content").length &&
        $jq1("meta[name='viewport']").attr("content").split(",").length < 4) {
        $jq1("meta[name='viewport']").attr("content", "width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0");
    }
    if ($jq1(".header-component .hdr-wrapper").length) {
        $jq1(".trigger-menu").css("transform", 'translateY('+ $jq1(".header-component .hdr-wrapper").height()+'px)');
    }
    /* $jq1(document).on("mouseenter", '.menu-item li', function () {
        openHeaderSubMenu($jq1(this));
    }); */
     /*DWEP-2514 logic to show solid cloud on hover and background highlihght conditionally in nav redesign */ 
     $jq1( ".submenu-links-footer" ).hover(
    function() {
      if($jq1(this).find('p').length >= 1){    //logic to add class for backgrounnd color for DWEP-2514 nav redesign
        $jq1(this).addClass('submenu-link-footer-para');
        if($jq1(this).find('a').length == 1){
            $jq1(this).find('a').addClass('submenu-link-footer-anchor');
        }
      }  //end of logic
      $jq1(this).find(".fa.fa-cloud").removeClass('fa').addClass("fas").addClass("solidCloud");

    }, function() {
        $jq1(this).removeClass('submenu-link-footer-para');
        $jq1(this).find(".fas.fa-cloud").removeClass('fas').addClass('fa').removeClass('solidCloud');
    }
  );
  /*end of function */

  /*DWEP-2514 logic to show solid cloud as image on hover in nav redesign */
  $jq1( ".submenu-links-footer a").hover(function(){
    if($jq1(this).hasClass('solid-cloud-hover')){
      if( ($jq1(this).parent().children()[0].tagName =='A') && ($jq1(this).find('img').length ==1)){
        $jq1(this).find('img').addClass('default');
        $jq1(this).append("<img src='https://www.vmware.com/content/dam/digitalmarketing/vmware/en/images/gallery/icons/cloud-FilledHoverstate.svg' class='hovered'></img>");

      }
  }
  })
  /*end of function */
  $jq1( ".submenu-links-footer a").focus(function(){
    if($jq1(this).hasClass('solid-cloud-hover')){
      if( ($jq1(this).parent().children()[0].tagName =='A') && ($jq1(this).find('img').length ==1)){
        $jq1(this).find('img').addClass('default');
        $jq1(this).append("<img src='https://www.vmware.com/content/dam/digitalmarketing/vmware/en/images/gallery/icons/cloud-FilledHoverstate.svg' class='hovered'></img>");
...
function loginhover(){
    if($('.dalmore-header').length == 1){   //DWEP-2514 login icon mobile view
        if ($(".right-arrow").hasClass("rotate")) {
          $(".right-arrow").removeClass("rotate");
          $(".dalmore-header .hdr-login a.login-link").removeClass('hovered');
        } else {
          $(".right-arrow").addClass("rotate");
        }
      }else{
        if ($(".plus-icon").hasClass("d-none")) {
          $(".plus-icon").removeClass("d-none");
          $(".minus-icon").addClass("d-none")
        } else {
            $(".plus-icon").addClass("d-none");
            $(".minus-icon").removeClass("d-none")
        }
      }
    }
    $jq1(document).on("mouseover",'.hdr-login', function (e){
      if($jq1(window).width() > 992 ){
         e.preventDefault();
         $jq1(".hdr-login-menu").removeClass("d-none");
         $jq1(".right-arrow").addClass("rotate");
          // loginhover();
      }
    /**$(".hdr-login .hdr-login-menu a:first").focus();**/
    });
    $jq1(document).on("mouseleave",'.hdr-login', function (e){
      if($jq1(window).width() > 992 ){
        $jq1(".hdr-login-menu").addClass("d-none");
        $jq1(".right-arrow").removeClass("rotate");
      }
    /**$(".hdr-login .hdr-login-menu a:first").focus();**/
    });
$jq1(document).on('click', '.hdr-login', function () {
    if ($jq1(window).width() <= 992 ) {
        ...
        // $(".right-arrow").toggleClass("rotate");
        loginhover();
  }
});
$jq1(document).ready(function () {
        ...
        $jq1(window).on("scroll load", function () {
            ...
            if (scrolled >= prevScrollTop) {
                if (scrolled > navHeight) {
                    ...
                    $jq1(".search-bar-comp").addClass('d-none');     //DWEP-2514 nav redesign hide search bar when scrolling
                    if ($jq1(window).width() <= 992) {
                        $jq1(".menu-item").addClass("hide-block-mobile");
                        $jq1("body").removeClass("overflow-hidden");
                        $jq1("body").css("overflow", "auto");
                    } else {
...
$jq1(document).on('click', '.search-icon', function () {
    ...
    if (!$jq1(".header-redesign-container").length) {  // If condition for nav redesign 2022 (code not needed for new header)
...
/* $jq1(document).on("click", '.menu-item li:not(.d-lg-none)', function () {
    openHeaderSubMenu($jq1(this));
}); */
function mobileViewSubmenuPanel(element) {
    if (window.matchMedia("(max-width: 992px)").matches) {
        ...
        $jq1(".submenu-component.submenu-redesign-container .bg-lightblue.cont-columns").closest(".container-comp-wrapper.row").addClass("columnReverse");
        $jq1(".submenu-component.submenu-redesign-container .horizontalcard").closest(".cont-columns.col-md-5").addClass("d-none d-lg-block");
    $jq1(".submenu-component.submenu-redesign-container .featurecard").find(".list-body").addClass("d-none d-lg-block");
    $jq1(".submenu-component.submenu-redesign-container .mb-40 > .submenu-links-footer").closest(".mb-40").addClass("mb-0");
$jq1(".submenu-component.submenu-redesign-container .mb-40 > .submenu-links-footer").closest(".cont-columns.col-md-6").addClass("mt-0");

    $jq1(".submenu-component.submenu-redesign-container .container-comp-wrapper>.cont-columns.col-md-12 section.aem-col-container>.container > div:not([class])").addClass("orderChange");
	$jq1(".submenu-component.submenu-redesign-container .container-comp-wrapper>.cont-columns.col-md-12 section.aem-col-container>.container > div.orderChange > div").addClass("orderRow");

  document.querySelectorAll(".orderChange .orderRow:first-child").forEach(function(EL) {
    EL.classList.add("orderRow1")
        ...
        if (!$jq1(".header-redesign-container").length) {  // If condition for nav redesign 2022 (code not needed for new header)
            $jq1(".submenu-component#" + wrapperID).find(".cont-columns").each(function (key, value) {
                if ($jq1(this).find(".linksContainer").length > 1) {
                    $jq1(this).find(".linksContainer:not(:last-child)").addClass("add-border-mobile");
                }
                //if(key === 0) {
                if ((key === 0) &&
                    !$jq1(this).find(".submenu-container > div").children().first().hasClass("links")) {
                    if ($jq1(this).find(".submenu-container .links .submenu-links-footer h6").length) {
...
$jq1(document).on("click", '.menu-item li:not(.d-lg-none)', function () {
    if (window.matchMedia("(max-width: 992px)").matches) {
        ...
        $jq1(".submenu-component").addClass('d-none');
         $jq1('.menu-item li a').removeClass("active");
    $jq1(this).find("a").addClass("active");
...
function openHeaderSubMenu(element) {
        var wrapperID = element.data("value");
        if ($jq1(window).width() > 992) {
			 if ($jq1(".header-redesign-container").length) {
				$jq1('body').addClass("no-scroll");
			 }
            $jq1(".submenu-component#" + wrapperID).find(".cont-columns").each(function (key, value) {
                if ($jq1(this).find(".linksContainer").length === 1) {
            ...
            $jq1(".submenu-component.submenu-redesign-container .container-comp-wrapper>div.col-md-9.cont-columns .divider").next(".custom-container-config").find(".column-cards .cont-columns:first").addClass("subtitlePick");
	  $jq1(".subtitlePick").each(function(){
		  if(!$jq1(this).find(".submenu-container-title").hasClass("header-margin")){
			  $jq1(this).siblings(".cont-columns").addClass("subtitleBlank");
		  }
	  })

      $jq1(".submenu-component.submenu-redesign-container .mb-40 > .submenu-links-footer").closest(".mb-40.mb-0").removeClass("mb-0");
...
$jq1(document).on('click', '.header-menu-icon', function () {
    if ($jq1(window).width() <= 992) {
        ...
        $jq1("body").addClass("overflow-hidden");
    ...
    if ($jq1(window).width() > 992) {
        if (code === 9) {
            if ($(this).find('a:last').is(':focus')) {
                ...
                $jq1(".menu-item li a.active").parent("li").next().find("a").focus();
                $jq1(this).addClass("d-none");
                $jq1(".menu-item li a").removeClass("active");
                return false;
            }
            if($(this).find('.cont-columns a:last').is(':focus')){   //DWEP-2514 accessibility issue
                $(".menu-item li a.active").parent("li").prev().next().find("a")[0].focus();
                console.log( $(".menu-item li a.active").parent("li").next().find("a")[0]);
        ...
        if (e.shiftKey && e.keyCode == 9) {
            if ($jq1(this).find('.submenu-container:first').find('a:first').is(':focus')) {
                ...
                if($(".menu-item li[data-value=" + currentMenu + "]").next().length == 0){
                    document.activeElement.blur();
                    $(".menu-item li[data-value=" + currentMenu + "]").find('a').focus();
                  }
            }else if ($(this).find('a:first').is(':focus')) { 
                if($(".menu-item li[data-value=" + currentMenu + "]").next().length == 0){
                  $(".menu-item li[data-value=" + currentMenu + "]").find("a.active").parent().prev().next().focus();
                  console.log("if condition 2--> 1-->"+ currentMenu);
                }else{
                  $(".menu-item li[data-value=" + currentMenu + "]").next().find("a").focus();
                  console.log('currentmenu first if condition 2 '+currentMenu);
                }
              }
              if($(this).find('a:first').parent().parent().is(':focus')){  //DWEP 2514 accessibility issue
                $(".menu-item li[data-value=" + currentMenu + "]").next().find("a").focus();
                console.log('currentmenu first if condition 3'+currentMenu);
              }
        }
    } else {
        if (e.shiftKey && e.keyCode == 9) {
...
$jq1(".skip-link").focus(function(){
    $jq1('html,body').animate({
      scrollTop: $jq1(".header-component").offset().top
  }, 600);
  });
...
function mobileViewSubmenuPanelNew(element) {
    if (window.matchMedia("(max-width: 992px)").matches) {
        $jq1(".submenu-container .submenu-header-title").siblings().addClass("hide-items hide-block-mobile")
            .removeClass("d-block");
        $jq1(".submenu-container .submenu-header-title").removeClass("minus-icon").addClass("plus-icon");
        var wrapperID = element.data("value");
        // $jq1(".submenu-component .header-flyout div:nth-child(n+2) .submenu-links-footer a")
        // .toggleClass('d-block')
        // .toggleClass('d-none');
        ...
        $jq1(".submenu-component#" + wrapperID).find(".cont-columns").each(function (key, value) {
            ...
            if ((key === 0) &&
                !$jq1(this).find(".submenu-container > div").children().first().hasClass("links")) {
                if ($jq1(this).find(".submenu-container .aem-GridColumn .submenu-links-footer h6").length) {
                    $jq1(this).find(".submenu-container").addClass("no-container-padding");
                    $jq1(this).find(".submenu-container .aem-GridColumn").addClass("border-top-mobile");
                    $jq1(this).find(".submenu-container .aem-GridColumn .submenu-links-footer h6").addClass("plus-icon submenu-header-title");
                    $jq1(this).find(".submenu-container .aem-GridColumn .submenu-links-footer a").addClass("hide-items").removeClass("d-block").addClass("hide-block-mobile");
                }
            } else {
                if (!$jq1(this).find(".submenu-container .submenu-container-title").length ||
                    !$jq1(this).find(".submenu-container .submenu-container-title").html().length) {
                    $jq1(this).closest(".container-comp-wrapper").find(".mobile-col-merge").each(function () {
                        $jq1(this).remove();
                    });
                    $jq1(this).find(".submenu-container").addClass("hide-block-mobile");
                    var cloneLinks = $jq1(this).find(".submenu-container .aem-Grid").children().clone();
                    $jq1(this).css("border-bottom", "none");
                    $jq1(this).addClass("hide-block-mobile");
                    $jq1(this).closest(".container-comp-wrapper").find(".cont-columns").eq(key - 1).find(".hide-block-mobile:not(.submenu-btn)").append(cloneLinks.addClass("mobile-col-merge"));
                } else {
                    $jq1(this).find(".submenu-container .submenu-container-title").addClass("plus-icon submenu-header-title");
                    $jq1(this).find(".submenu-container .submenu-container-title").siblings().addClass("hide-items hide-block-mobile");
                }
...
$jq1(document).on("click", '.header-menu .menu-item li[data-value="multicloud"]', function () {
    if (!$(".submenu-redesign-container").length && !$(".header-redesign-container").length) {
        if (window.matchMedia("(max-width: 992px)").matches) {
            $jq1(".menu-item").addClass("hide-block-mobile");
            $jq1(".submenu-component").addClass('d-none');
        }
        $jq1('.menu-item li a').removeClass("active");
        $jq1(this).find("a").addClass("active");
        mobileViewSubmenuPanelNew($jq1(this));
    }
});
$jq1(window).resize(function () {
    if ($jq1(window).width() <= 992) {
        ...
        if (!$(".submenu-redesign-container").length && !$(".header-redesign-container").length) {
            var element = $jq1(".menu-item li[data-value='multicloud'] a.active").parent("li");

            mobileViewSubmenuPanelNew(element);
        }
    } else {
        $jq1(".submenu-component .mobile-col-merge").show();
        $jq1(".submenu-component .mobile-col-merge").remove();
...
/** Nav redesign 2022 starts */
var utilityhtml, searchhtml;
...
$jq1(document).ready(function () {
    if ($jq1(".header-redesign-container").length) {
        ...
        {	
            var head  = document.getElementsByTagName('head')[0];var ele = head.querySelector('link[href*="responsive.css"]');	
            var link  = document.createElement('link');	
            link.id   = cssId;	
            link.rel  = 'stylesheet';	
            link.type = 'text/css';	
            link.href = 'https://www.vmware.com/etc.clientlibs/vmware-modernize-cms/componentlibrary/clientlibs/clientlib-scraper-component.min.css';	
            link.media = 'all';	
            head.prepend('beforebegin',link);	
        }
        utilityhtml = $jq1('.header-redesign-container .utility-menu.hide-block-mobile').html();
        searchhtml = $jq1('.header-redesign-container .hdr-search').html();

        $jq1('.menu-item li').click(function () {
             /*DWEP-2514 nav redesign check if search is open and close it */
            if(!$jq1(".search-bar-comp").hasClass("d-none")){
                $jq1(".search-bar-comp").addClass("d-none");
                $jq1('.dalmore-header .header-component').css('position','absolute');
            }
      /*end of logic */
        var _id=$jq1(this).data('value'); 
           $jq1('#'+_id).hasClass('d-none') ? openHeaderSubMenu($jq1(this)) : closeSubmenu();

           var storeSubmenuLinkFooterLinks = $jq1('.dalmore-header #'+_id+" .submenu-container .submenu-links-footer a");
           for(var i=0;i<storeSubmenuLinkFooterLinks.length;i++){
            var getChildNode = storeSubmenuLinkFooterLinks[i];
             if($jq1(getChildNode).children().length == 0){
                $jq1(getChildNode).parent().addClass('adjustSpacing');
             }
           }
           $jq1(".submenu-redesign-container .cont-columns").each(function(){	
            var cardLength = $jq1(this).find(".card-box").length;	
        	
                 if(cardLength==1 && !$('.dalmore-header').length == 1){	 //commenting out since we do not need the background to spread across the container for DWEP-2514 nav redesign
                    $jq1(this).find(".card-box.bg-lightblue").closest(".cont-columns").addClass("bg-lightblue");	
                    $jq1(this).find(".card-box.bg-lightgray").closest(".cont-columns").addClass("bg-lightgray");	
                    $jq1(this).find(".card-box.bg-ocean").closest(".cont-columns").addClass("bg-ocean");	
                    $jq1(this).find(".card-box.bg-indigo").closest(".cont-columns").addClass("bg-indigo");	
                    	
                  }
          })

            /*logic to add class to p under solutions menu item DWEP-2514 */
     if(_id.toLowerCase() == "solutions"){
        $jq1('.dalmore-header #'+_id+" .submenu-links-footer p .text-xxss").addClass("solutions_menu_subheading");
        //$jq1('.dalmore-header #'+_id+" .submenu-links-footer").parent().parent().addClass("linksToppadding");
        for(var i=0;i<$jq1('.dalmore-header #'+_id+" .submenu-links-footer").length;i++){
            var checkingSpacing = $jq1('.dalmore-header #'+_id+" .submenu-links-footer")[i];
            if(!$jq1(checkingSpacing).hasClass('adjustSpacing')){
                $jq1(checkingSpacing).parent().parent().addClass("linksToppadding");
            }
        }
      }
      /*end of function */
      $jq1('.dalmore-header #'+_id+" .container-footer").removeClass('mt-5').addClass("mt-2");
      if($jq1('.dalmore-header #'+_id+" .container-footer").hasClass('mb-3')){
        $jq1('.dalmore-header #'+_id+" .container-footer.mb-3").css("display","none");
       }     //adjusting the padding of footer buttons
       if($jq1(".dalmore-header #products .divider.aem-GridColumn")[0] != undefined){
       var footerParentContainer = $jq1(".dalmore-header #products .divider.aem-GridColumn")[0].nextElementSibling;
       $jq1(footerParentContainer).addClass('footerParentDiv');  
       $jq1('.footerParentDiv .container-comp-wrapper .cont-columns').addClass('footer');
       }

      /*logic to remove padding for sub text DWEP-2514 */
      var getPTags = $jq1(".dalmore-header .submenu-component .cont-columns>div>div>div:not(.linksContainer).submenu-container:not(:first-child) h5.submenu-container-title");
      for(var i=0;i<getPTags.length;i++){
        var pTags = getPTags[i].nextElementSibling;
        $jq1(pTags).addClass('removepadding');
      }
      /*end of logic */
      /*DWEP-2514 changes for nav redesign moving grey card container to the bottom in mobile  */
      var bgClassContainer;
      if($jq1('.dalmore-header #' + _id+" .aem-col-container[class*='bg-']").length > 0){
        $jq1('.dalmore-header #'+_id+" .aem-col-container[class*='bg-'] .submenu-links-footer").addClass('adjustGreyContainerSpacing');
          if($jq1('.dalmore-header #' + _id+" div .card .componentBody .card-box").length == 0){
            bgClassContainer = $jq1('.dalmore-header #' + _id+" .aem-col-container[class*='bg-']").last();
                if(!$jq1(bgClassContainer).hasClass("moveGreyContainer")){
                    $jq1(bgClassContainer).addClass("moveGreyContainer").clone().insertAfter($jq1('.dalmore-header #' + _id).children().last().children().last());
                }
        }
      }else if($jq1('.dalmore-header #' + _id+" .textcard[class*='bg-']").length > 0){
        if(!$jq1('.dalmore-header #' + _id+" .textcard[class*='bg-']").hasClass("moveGreyContainer")){
            $jq1('.dalmore-header #' + _id+" .textcard[class*='bg-']").addClass("moveGreyContainer").clone().insertAfter($jq1('.dalmore-header #' + _id).children().last().children().last());
        }
      }
      if ($jq1(window).width() <= 992) {
        if($jq1('.dalmore-header #' + _id+" div .card .componentBody .card-box").length == 0){
            $jq1('.dalmore-header #' + _id+" .aem-col-container[class*='bg-']").css("display","none");
            $jq1('.dalmore-header #' + _id+" .moveGreyContainer").last().css("display","block");
        }
        $jq1('.dalmore-header #' + _id+" .textcard[class*='bg-']").css("display","none");
        $jq1('.dalmore-header #' + _id+" .textcard[class*='bg-']").last().css("display","block");
      }else{
        $jq1('.dalmore-header #' + _id+" .aem-col-container[class*='bg-']").css("display","block");
        $jq1('.dalmore-header #' + _id+" .textcard[class*='bg-']").css("display","block");
        $jq1('.dalmore-header #' + _id+" .textcard[class*='bg-']").last().css("display","none");
        $jq1('.dalmore-header #' + _id+" .moveGreyContainer").last().css("display","none");
      }
      /*end of changes */
    });
          $jq1('.menu-item li').keydown(function () {
     ...
     if(_id.toLowerCase() == "solutions"){
      ...
      /*end of changes */
          ...
          $jq1(document).on('click', '.header-menu .search-icon', function () {
            if($jq1(".dalmore-header").length == 1){   //DWEP-2514 changes for nav redesign
                $jq1('.dalmore-header .header-component').css('position','relative');
            $jq1(".search-bar-comp").css("top",$jq1(".header-component .hdr-wrapper").height());
            $jq1(".search-bar-comp").toggleClass("d-none");
              $jq1(".dalmore-header .top-nav").toggleClass("search-open");
              if(!$jq1(".search-bar-comp").hasClass("d-none")){
                $jq1(".submenu-component").addClass("d-none");
                $jq1(".menu-item li a").removeClass("active");
                $jq1('body').removeClass("no-scroll");
              }
              $jq1(".dalmore-header #ub-search").val("");
              $jq1(".dalmore-header #ub-search").focus();
            }else{
                $jq1("#ub-search").toggleClass("d-none");  
                $jq1(".top-nav").toggleClass("search-open");
                $jq1("#ub-search").val("");
          ...
          $jq1(document).on('click', '.search-bar-comp .close-icon', function (e) {
               //DWEP-2514 changes for nav redesign
               if(e.type == 'click'){
                $jq1(".search-bar-comp").addClass("d-none");
               }else if(e.keyCode == 13){
                $jq1(".search-bar-comp").addClass("d-none");
                $jq1('.dalmore-header .header-menu .search-icon').focus();
               }
            });
            /*DWEP-2514 nav redesign clicking outside closes the search box */
            $jq1(".root").click(function(){
                $jq1(".search-bar-comp").addClass("d-none");
              })
        ...
        if ($jq1(window).width() <= 992) {
           if($jq1(".header-redesign-container .menu-item li.d-lg-none input#ub-search").length !=1){
				$jq1('.header-redesign-container .menu-item').append('<li class="d-lg-none">' + utilityhtml + '</li>');
				$jq1('.header-redesign-container .menu-item').prepend('<li class="d-lg-none">' + searchhtml + '</li>');
		}

        } else {
            $jq1('.header-redesign-container .menu-item > .d-lg-none').remove();

        }
    }else{
			$jq1(document).on('mouseenter', '.menu-item li:not(.d-lg-none)', function () {
			  openHeaderSubMenu($jq1(this));
			});
			$jq1(document).on("mouseover", function (e) {
			  // if ($jq1(window).width() > 992) {
...
$jq1(window).resize(function () {
    if ($jq1(".header-redesign-container").length) {
        if ($jq1(window).width() <= 992) {
             /*DWEP-2514 nav redesign changes to move grey card to the bottom in mobile */
    var containerHolder = $(".dalmore-header .aem-col-container.submenu-component.submenu-redesign-container");
    for(var i=0;i<containerHolder.length;i++){
        if(!containerHolder[i].getAttribute('class').includes('d-none')){
            var _id = containerHolder[i].getAttribute("id");
            $jq1(".dalmore-header #"+_id+" .moveGreyContainer").first().css("display","none");
            $jq1('.dalmore-header #' + _id+" .moveGreyContainer").last().css("display","block");
        }
    }
    /*end of changes */
           if($jq1(".header-redesign-container .menu-item li.d-lg-none input#ub-search").length !=1){
             ...
             /*DWEP-2514 nav redesign changes for grey card to the bottom in mobile */
     var containerHolder = $jq1(".dalmore-header .aem-col-container.submenu-component.submenu-redesign-container");
     for(var i=0;i<containerHolder.length;i++){
         if(!containerHolder[i].getAttribute('class').includes('d-none')){
             var _id = containerHolder[i].getAttribute("id");
             $jq1(".dalmore-header #"+_id+" .moveGreyContainer").first().css("display","block");
             $jq1('.dalmore-header #' + _id+" .moveGreyContainer").last().css("display","none");
         }
     }
     /*end of changes */
            $jq1('.menu-item > .d-lg-none').remove();
        }
    }
});

/** Nav redesign 2022 ends */