...
if(g!==f&&c(f)!==c(g)){console.warn("HTML tags must be properly nested and closed: "+f)
}}d.UNSAFE_restoreLegacyHtmlPrefilter=function(){d.htmlPrefilter=function(f){a(f);
return f.replace(e,"<$1></$2>")
}
};
